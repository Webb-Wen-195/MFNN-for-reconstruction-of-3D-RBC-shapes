...
def main():
    ...
    image_path = ROOT_DIR / "In_image" / "Image_Echino2.png"
    N_outline  = 2048
    Lx_um      = 8.5
    fs         = 25
    Rot_Angle  = -5.0
    ...
    STEPS = [
        ...
        "Save    E2_exp_partial_yz.npz + E2_shown.png",
    ]
    ...
    with tqdm(total=len(STEPS), bar_format="{l_bar}{bar}| {n_fmt}/{total_fmt} [{elapsed}<{remaining}]",
        ...
        plt.tight_layout()
        plt.savefig(ROOT_DIR / "Out_graph" / "E2_p1234.png", dpi=300, bbox_inches="tight")
        plt.close()
        pbar.update(1)
        ...
        np.savez(ROOT_DIR / "Out_data4MFNN" / "E2_exp_partial_yz.npz",
        ...
        plt.savefig(ROOT_DIR / "Out_graph" / "E2_shown.png", dpi=300, bbox_inches="tight")
        plt.close()
        pbar.update(1)
